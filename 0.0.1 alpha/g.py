...
if __name__ == '__main__':
    ...
    hero_up2 = pygame.image.load('data/main3_left.png').convert_alpha()
    hero_up3 = pygame.image.load('data/main3_right.png').convert_alpha()
    ...
    sprites_for_hero_animation = [hero_down2, hero_down3, hero_right2, hero_right, hero_right3, hero_right, hero_left2, hero_left, hero_left3, hero_left, hero_up2, hero_up3]
    ...
    hitbox = Sprite(hero_hitbox, Hero.hitbox_pos[0], Hero.hitbox_pos[1], hero_hitbox.get_size()[1], barrier_sprites)
