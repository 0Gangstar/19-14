...
class Player(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        self.pos[0] += x
        self.pos[1] += y
        self.hit_polygon_pos[0] += x
        self.hit_polygon_pos[1] += y
        self.interaction_box_pos[0] += x
        self.interaction_box_pos[1] += y

        self.rect.center = self.pos
        self.hit_polygon.topleft = self.hit_polygon_pos
...
player_sprite = pygame.image.load('data/hero2.png').convert_alpha()
...
player = Player(player_sprite.get_size(), width / 2, height / 2)
